...
import java.util.Scanner;
    ...
    public class LabSecond {
        ...
        public static final int MAX_DIMENSIONS = 20;
        ...
        private static int enterMatrixDimension(Scanner scanner){
            ...
            while (number> MAX_DIMENSIONS ||number<MIN_DIMENSIONS)
            {
                System.out.println("number must be between " + MIN_DIMENSIONS +" and" + MAX_DIMENSIONS +"\nPlease enter other num:");
                number = scanner.nextInt();
            }
            return number;
        }
